    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="content">
                    <p class="explanation">
                        This is a podcast RSS feed generated by <a href="http://www.seriouslysimplepodcasting.com/" target="_blank">Media Portfolios Podcasting</a>. It is meant for consumption by podcast feed readers using the URL in the address bar.
                    </p>
