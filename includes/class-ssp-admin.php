...
class MPP_Admin {
	...
	public function register_post_type() {
		...
		$labels = array(
			'name'                  => _x( 'Podcast', 'post type general name', 'mps-podcasts' ),
			'singular_name'         => _x( 'Podcast', 'post type singular name', 'mps-podcasts' ),
			'add_new'               => _x( 'Add New', 'podcast', 'mps-podcasts' ),
			'add_new_item'          => sprintf( __( 'Add New %s', 'mps-podcasts' ), __( 'Episode', 'mps-podcasts' ) ),
			'edit_item'             => sprintf( __( 'Edit %s', 'mps-podcasts' ), __( 'Episode', 'mps-podcasts' ) ),
			'new_item'              => sprintf( __( 'New %s', 'mps-podcasts' ), __( 'Episode', 'mps-podcasts' ) ),
			'all_items'             => sprintf( __( 'All %s', 'mps-podcasts' ), __( 'Episodes', 'mps-podcasts' ) ),
			'view_item'             => sprintf( __( 'View %s', 'mps-podcasts' ), __( 'Episode', 'mps-podcasts' ) ),
			'search_items'          => sprintf( __( 'Search %a', 'mps-podcasts' ), __( 'Episodes', 'mps-podcasts' ) ),
			'not_found'             => sprintf( __( 'No %s Found', 'mps-podcasts' ), __( 'Episodes', 'mps-podcasts' ) ),
			'not_found_in_trash'    => sprintf( __( 'No %s Found In Trash', 'mps-podcasts' ), __( 'Episodes', 'mps-podcasts' ) ),
			'parent_item_colon'     => '',
			'menu_name'             => __( 'Podcast', 'mps-podcasts' ),
			'filter_items_list'     => sprintf( __( 'Filter %s list', 'mps-podcasts' ), __( 'Episode', 'mps-podcasts' ) ),
			'items_list_navigation' => sprintf( __( '%s list navigation', 'mps-podcasts' ), __( 'Episode', 'mps-podcasts' ) ),
			'items_list'            => sprintf( __( '%s list', 'mps-podcasts' ), __( 'Episode', 'mps-podcasts' ) ),
		);
	...
	private function register_taxonomies() {
		...
		$series_labels = array(
			'name'                       => __( 'Podcast Series', 'mps-podcasts' ),
			'singular_name'              => __( 'Series', 'mps-podcasts' ),
			'search_items'               => __( 'Search Series', 'mps-podcasts' ),
			'all_items'                  => __( 'All Series', 'mps-podcasts' ),
			'parent_item'                => __( 'Parent Series', 'mps-podcasts' ),
			'parent_item_colon'          => __( 'Parent Series:', 'mps-podcasts' ),
			'edit_item'                  => __( 'Edit Series', 'mps-podcasts' ),
			'update_item'                => __( 'Update Series', 'mps-podcasts' ),
			'add_new_item'               => __( 'Add New Series', 'mps-podcasts' ),
			'new_item_name'              => __( 'New Series Name', 'mps-podcasts' ),
			'menu_name'                  => __( 'Series', 'mps-podcasts' ),
			'view_item'                  => __( 'View Series', 'mps-podcasts' ),
			'popular_items'              => __( 'Popular Series', 'mps-podcasts' ),
			'separate_items_with_commas' => __( 'Separate series with commas', 'mps-podcasts' ),
			'add_or_remove_items'        => __( 'Add or remove Series', 'mps-podcasts' ),
			'choose_from_most_used'      => __( 'Choose from the most used Series', 'mps-podcasts' ),
			'not_found'                  => __( 'No Series Found', 'mps-podcasts' ),
			'items_list_navigation'      => __( 'Series list navigation', 'mps-podcasts' ),
			'items_list'                 => __( 'Series list', 'mps-podcasts' ),
		);
		...
		$labels = array(
			'name'                       => __( 'Tags', 'mps-podcasts' ),
			'singular_name'              => __( 'Tag', 'mps-podcasts' ),
			'search_items'               => __( 'Search Tags', 'mps-podcasts' ),
			'popular_items'              => __( 'Popular Tags', 'mps-podcasts' ),
			'all_items'                  => __( 'All Tags', 'mps-podcasts' ),
			'parent_item'                => null,
			'parent_item_colon'          => null,
			'edit_item'                  => __( 'Edit Tag', 'mps-podcasts' ),
			'update_item'                => __( 'Update Tag', 'mps-podcasts' ),
			'add_new_item'               => __( 'Add New Tag', 'mps-podcasts' ),
			'new_item_name'              => __( 'New Tag Name', 'mps-podcasts' ),
			'separate_items_with_commas' => __( 'Separate tags with commas', 'mps-podcasts' ),
			'add_or_remove_items'        => __( 'Add or remove tags', 'mps-podcasts' ),
			'choose_from_most_used'      => __( 'Choose from the most used tags', 'mps-podcasts' ),
			'not_found'                  => __( 'No tags found.', 'mps-podcasts' ),
			'menu_name'                  => __( 'Tags', 'mps-podcasts' ),
		);
	...
	public function series_image_uploader( $taxonomy, $mode = 'CREATE', $term = null ) {
		...
		$series_img_title = __( 'Series Image', 'mps-podcasts' );
		$upload_btn_text  = __( 'Choose series image', 'mps-podcasts' );
		$upload_btn_value = __( 'Add Image', 'mps-podcasts' );
		$upload_btn_title = __( 'Choose an image file', 'mps-podcasts' );
		$series_img_desc  = __( "Set an image as the artwork for the series. No image will be set if not provided.", 'mps-podcasts' );
...
HTML;
	...
	public function register_meta() {
		...
		$fields['filesize_raw'] = array(
			'meta_description' => __( 'The raw file size of the podcast episode media file in bytes.', 'mps-podcasts' ),
		);
	...
	public function register_custom_column_headings( $defaults ) {
		$new_columns = apply_filters( 'ssp_admin_columns_episodes', array(
			'series' => __( 'Series', 'mps-podcasts' ),
			'image'  => __( 'Image', 'mps-podcasts' ),
		) );
	...
	public function edit_series_columns( $columns ) {
		...
		$columns['series_image']    = __( 'Series Image', 'mps-podcasts' );
		$columns['series_feed_url'] = __( 'Series feed URL', 'mps-podcasts' );
		$columns['posts']           = __( 'Episodes', 'mps-podcasts' );
...
HTML;
	...
	public function updated_messages( $messages ) {
		...
		$messages[ $this->token ] = array(
			0  => '',
			1  => sprintf( __( 'Episode updated. %sView episode%s.', 'mps-podcasts' ), '<a href="' . esc_url( get_permalink( $post_ID ) ) . '">', '</a>' ),
			2  => __( 'Custom field updated.', 'mps-podcasts' ),
			3  => __( 'Custom field deleted.', 'mps-podcasts' ),
			4  => __( 'Episode updated.', 'mps-podcasts' ),
			5  => isset( $_GET['revision'] ) ? sprintf( __( 'Episode restored to revision from %s.', 'mps-podcasts' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6  => sprintf( __( 'Episode published. %sView episode%s.', 'mps-podcasts' ), '<a href="' . esc_url( get_permalink( $post_ID ) ) . '">', '</a>' ),
			7  => __( 'Episode saved.', 'mps-podcasts' ),
			8  => sprintf( __( 'Episode submitted. %sPreview episode%s.', 'mps-podcasts' ), '<a target="_blank" href="' . esc_url( add_query_arg( 'preview', 'true', get_permalink( $post_ID ) ) ) . '">', '</a>' ),
			9  => sprintf( __( 'Episode scheduled for: %1$s. %2$sPreview episode%3$s.', 'mps-podcasts' ), '<strong>' . date_i18n( __( 'M j, Y @ G:i', 'mps-podcasts' ), strtotime( $post->post_date ) ) . '</strong>', '<a target="_blank" href="' . esc_url( get_permalink( $post_ID ) ) . '">', '</a>' ),
			10 => sprintf( __( 'Episode draft updated. %sPreview episode%s.', 'mps-podcasts' ), '<a target="_blank" href="' . esc_url( add_query_arg( 'preview', 'true', get_permalink( $post_ID ) ) ) . '">', '</a>' ),
		);
	...
	public function meta_box_setup( $post ) {
		global $pagenow;
		add_meta_box( 'podcast-episode-data', __( 'Podcast Episode Details', 'mps-podcasts' ), array(
			$this,
			'meta_box_content'
		), $post->post_type, 'normal', 'high' );

		if ( 'post.php' == $pagenow && 'publish' == $post->post_status && function_exists( 'get_post_embed_html' ) ) {
			add_meta_box( 'episode-embed-code', __( 'Episode Embed Code', 'mps-podcasts' ), array(
				$this,
	...
	public function embed_code_meta_box_content( $post ) {
		...
		$html = '<p><em>' . __( 'Customise the size of your episode embed below, then copy the HTML to your clipboard.', 'mps-podcasts' ) . '</em></p>';
		$html .= '<p><label for="episode_embed_code_width">' . __( 'Width:', 'mps-podcasts' ) . '</label> <input id="episode_embed_code_width" class="episode_embed_code_size_option" type="number" value="500" length="3" min="0" step="1" /> &nbsp;&nbsp;&nbsp;&nbsp;<label for="episode_embed_code_height">' . __( 'Height:', 'mps-podcasts' ) . '</label> <input id="episode_embed_code_height" class="episode_embed_code_size_option" type="number" value="350" length="3" min="0" step="1" /></p>';
	...
	public function meta_box_content() {
		...
		if ( 0 < count( $field_data ) ) {
			...
			foreach ( $field_data as $k => $v ) {
				...
				switch ( $v['type'] ) {
					case 'file':
						$upload_button = '<input type="button" class="button" id="upload_' . esc_attr( $k ) . '_button" value="' . __( 'Upload File', 'mps-podcasts' ) . '" data-uploader_title="' . __( 'Choose a file', 'mps-podcasts' ) . '" data-uploader_button_text="' . __( 'Insert podcast file', 'mps-podcasts' ) . '" />';
	...
	public function custom_fields() {
		...
		$fields['episode_type'] = array(
			'name'             => __( 'Episode type:', 'mps-podcasts' ),
			'description'      => '',
			'type'             => 'radio',
			'default'          => 'audio',
			'options'          => array(
				'audio' => __( 'Audio', 'mps-podcasts' ),
				'video' => __( 'Video', 'mps-podcasts' )
			),
			'section'          => 'info',
			'meta_description' => __( 'The type of podcast episode - either Audio or Video', 'mps-podcasts' ),
		);
		...
		$fields['audio_file'] = array(
			'name'             => __( 'Podcast file:', 'mps-podcasts' ),
			'description'      => __( 'Upload the primary podcast file or paste the file URL here.', 'mps-podcasts' ),
			'type'             => 'file',
			'default'          => '',
			'section'          => 'info',
			'meta_description' => __( 'The full URL for the podcast episode media file.', 'mps-podcasts' ),
		);
		...
		if ( ssp_is_connected_to_podcastmotor() ) {
			$fields['podmotor_file_id'] = array(
				...
				'default'          => '',
				'section'          => 'info',
				'meta_description' => __( 'Seriously Simple Hosting file id.', 'mps-podcasts' ),
			);
		}

		$fields['duration'] = array(
			'name'             => __( 'Duration:', 'mps-podcasts' ),
			'description'      => __( 'Duration of podcast file for display (calculated automatically if possible).', 'mps-podcasts' ),
			'type'             => 'text',
			'default'          => '',
			'section'          => 'info',
			'meta_description' => __( 'The duration of the file for display purposes.', 'mps-podcasts' ),
		);

		$fields['filesize'] = array(
			'name'             => __( 'File size:', 'mps-podcasts' ),
			'description'      => __( 'Size of the podcast file for display (calculated automatically if possible).', 'mps-podcasts' ),
			'type'             => 'text',
			'default'          => '',
			'section'          => 'info',
			'meta_description' => __( 'The size of the podcast episode for display purposes.', 'mps-podcasts' ),
		);
		...
		if ( ssp_is_connected_to_podcastmotor() ) {
			$fields['filesize_raw'] = array(
				...
				'default'          => '',
				'section'          => 'info',
				'meta_description' => __( 'Raw size of the podcast episode.', 'mps-podcasts' ),
			);
		}

		$fields['date_recorded'] = array(
			'name'             => __( 'Date recorded:', 'mps-podcasts' ),
			'description'      => __( 'The date on which this episode was recorded.', 'mps-podcasts' ),
			'type'             => 'datepicker',
			'default'          => '',
			'section'          => 'info',
			'meta_description' => __( 'The date on which the podcast episode was recorded.', 'mps-podcasts' ),
		);

		$fields['explicit'] = array(
			'name'             => __( 'Explicit:', 'mps-podcasts' ),
			'description'      => __( 'Mark this episode as explicit.', 'mps-podcasts' ),
			'type'             => 'checkbox',
			'default'          => '',
			'section'          => 'info',
			'meta_description' => __( 'Indicates whether the episode is explicit.', 'mps-podcasts' ),
		);

		$fields['block'] = array(
			'name'             => __( 'Block:', 'mps-podcasts' ),
			'description'      => __( 'Block this episode from appearing in the iTunes & Google Play podcast libraries.', 'mps-podcasts' ),
			'type'             => 'checkbox',
			'default'          => '',
			'section'          => 'info',
			'meta_description' => __( 'Indicates whether this specific episode should be blocked from the iTunes and Google Play Podcast libraries.', 'mps-podcasts' ),
		);
		...
		if ( $is_itunes_fields_enabled && $is_itunes_fields_enabled == 'on' ) {
			...
			$fields['itunes_episode_number'] = array(
				'name'             => __( 'iTunes Episode Number:', 'mps-podcasts' ),
				'description'      => __( 'The iTunes Episode Number. Leave Blank If None.', 'mps-podcasts' ),
				'type'             => 'number',
				'default'          => '',
				'section'          => 'info',
				'meta_description' => __( 'The iTunes Episode Number. Leave Blank If None.', 'mps-podcasts' ),
			);
			...
			$fields['itunes_title'] = array(
				'name'             => __( 'iTunes Episode Title (Exclude Your Series / Show Number):', 'mps-podcasts' ),
				'description'      => __( 'The iTunes Episode Title. NO Series / Show Number Should Be Included.', 'mps-podcasts' ),
				'type'             => 'text',
				'default'          => '',
				'section'          => 'info',
				'meta_description' => __( 'The iTunes Episode Title. NO Series / Show Number Should Be Included', 'mps-podcasts' ),
			);
			...
			$fields['itunes_season_number'] = array(
				'name'             => __( 'iTunes Season Number:', 'mps-podcasts' ),
				'description'      => __( 'The iTunes Season Number. Leave Blank If None.', 'mps-podcasts' ),
				'type'             => 'number',
				'default'          => '',
				'section'          => 'info',
				'meta_description' => __( 'The iTunes Season Number. Leave Blank If None.', 'mps-podcasts' ),
			);
			...
			$fields['itunes_episode_type'] = array(
				'name'             => __( 'iTunes Episode Type:', 'mps-podcasts' ),
				'description'      => '',
				'type'             => 'select',
				'default'          => '',
				'options'          => array(
					''        => __( 'Please Select', 'mps-podcasts' ),
					'full'    => __( 'Full: For Normal Episodes', 'mps-podcasts' ),
					'trailer' => __( 'Trailer: Promote an Upcoming Show', 'mps-podcasts' ),
					'bonus'   => __( 'Bonus: For Extra Content Related To a Show', 'mps-podcasts' )
				),
				'section'          => 'info',
				'meta_description' => __( 'The iTunes Episode Type', 'mps-podcasts' ),
			);
		}
	...
	public function glance_items( $items = array() ) {
		...
		$text = _n( '%s Episode', '%s Episodes', $num_posts, 'mps-podcasts' );
	...
	/**
	 * Adding appreciation links to the MPP record in the plugin list table
	 *
	...
	public function plugin_row_meta( $plugin_meta = array(), $plugin_file = '', $plugin_data = array(), $status = '' ) {
		...
		$plugin_meta['docs']   = '<a href="http://www.seriouslysimplepodcasting.com/documentation/" target="_blank">' . __( 'Documentation', 'mps-podcasts' ) . '</a>';
		$plugin_meta['addons'] = '<a href="http://www.seriouslysimplepodcasting.com/add-ons/" target="_blank">' . __( 'Add-ons', 'mps-podcasts' ) . '</a>';
		$plugin_meta['review'] = '<a href="https://wordpress.org/support/view/plugin-reviews/' . $plugin_data['slug'] . '?rate=5#postform" target="_blank">' . __( 'Write a review', 'mps-podcasts' ) . '</a>';
		return $plugin_meta;
	}
	...
	public function enter_title_here( $title ) {
		if ( get_post_type() == $this->token ) {
			$title = __( 'Enter episode title here', 'mps-podcasts' );
		}
	...
	public function enqueue_admin_scripts( $hook ) {
		...
		// Only enqueue the WordPress Media Library picker for adding and editing MPP tags/terms post types.
