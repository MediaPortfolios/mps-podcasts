...
/**
 * Media Portfolios Podcasting Single Podcast Episode Widget
 *
 ...
 * @since 		1.9.0
 */
class MPP_Widget_Single_Episode extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a single podcast episode.', 'mps-podcasts' );
		$this->widget_idbase = 'ss_podcast';
		$this->widget_title = __( 'Podcast: Single Episode', 'mps-podcasts' );
...
?>
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'mps-podcasts' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" placeholder="<?php _e( 'Use episode title', 'mps-podcasts' ); ?>" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'episode_id' ); ?>"><?php _e( 'Episode:', 'mps-podcasts' ); ?></label>
		<select id="<?php echo $this->get_field_id( 'episode_id' ); ?>" name="<?php echo $this->get_field_name( 'episode_id' ); ?>">
			<option value="0"><?php _e( '- Latest episode -', 'mps-podcasts' ); ?></option>
			<?php
		...
		<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Display episode title inside widget?', 'mps-podcasts' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>"><?php _e( 'Display episode excerpt?', 'mps-podcasts' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_content' ); ?>"><?php _e( 'Display full episode content?', 'mps-podcasts' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_player' ); ?>"><?php _e( 'Display episode audio player?', 'mps-podcasts' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_details' ); ?>"><?php _e( 'Display episode details?', 'mps-podcasts' ); ?></label></p>
<?php
	}
} // End Class
