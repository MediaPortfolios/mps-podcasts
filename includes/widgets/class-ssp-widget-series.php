...
/**
 * Media Portfolios Podcasting Podcast Series Widget
 *
 ...
 * @since 		1.9.0
 */
class MPP_Widget_Series extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a list of episodes from a single series.', 'mps-podcasts' );
		$this->widget_idbase = 'ss_podcast';
		$this->widget_title = __( 'Podcast: Series', 'mps-podcasts' );
...
?>
		...
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" placeholder="<?php _e( 'Use series title', 'mps-podcasts' ); ?>" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'series_id' ); ?>"><?php _e( 'Series:', 'mps-podcasts' ); ?></label>
		...
		<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Display series title inside widget?', 'mps-podcasts' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_desc' ); ?>"><?php _e( 'Display series description?', 'mps-podcasts' ); ?></label></p>

		<p><input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo $this->get_field_id( 'show_date' ); ?>" name="<?php echo $this->get_field_name( 'show_date' ); ?>" />
		<label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e( 'Display episode date?', 'mps-podcasts' ); ?></label></p>
<?php
	}
} // End Class
